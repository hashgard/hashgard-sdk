...
test_sim_custom_genesis_fast:
	...
	@go test -mod=readonly $(SIMAPP) -run TestFullAppSimulation -Genesis=${HOME}/.hashgardd/config/genesis.json \
...
test_sim_custom_genesis_multi_seed: runsim
	...
	@echo "By default, ${HOME}/.hashgardd/config/genesis.json will be used."
	@$(BINDIR)/runsim -Genesis=${HOME}/.hashgardd/config/genesis.json -SimAppPkg=$(SIMAPP) 400 5 TestFullAppSimulation
