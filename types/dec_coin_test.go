...
func TestParseDecCoins(t *testing.T) {
	testCases := []struct {
		...
		{"", nil, false},
		{"4ugard", nil, true},
		{"5.5atom,4ugard", nil, true},
		{"0.0ugard", nil, true},
		{"0.004STAKE", nil, true},
		{
			"0.004ugard",
			DecCoins{NewDecCoinFromDec("ugard", NewDecWithPrec(4000000000000000, Precision))},
			false,
		},
		{
			"5.04atom,0.004ugard",
			DecCoins{
				...
				NewDecCoinFromDec("ugard", NewDecWithPrec(4000000000000000, Precision)),
			},
			false,
		},
	}
...
func TestDecCoinsString(t *testing.T) {
	testCases := []struct {
		...
		{DecCoins{}, ""},
		{
			...
			"5.040000000000000000atom,0.004000000000000000ugard",
		},
	}
...
func TestDecCoinsIntersect(t *testing.T) {
	testCases := []struct {
		...
		{"", "", ""},
		{"1.0ugard", "", ""},
		{"1.0ugard", "1.0ugard", "1.0ugard"},
		{"", "1.0ugard", ""},
		{"1.0ugard", "", ""},
		{"2.0stake,1.0trope", "1.9ugard", "1.9ugard"},
		{"2.0stake,1.0trope", "2.1ugard", "2.0ugard"},
