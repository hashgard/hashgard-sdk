...
- [REST API 规范](https://cosmos.network/rpc/): 通过 REST 与 `hashgard` 全节点交互的 API 列表。
...
Cosmos Hub (名为 `hashgard`) 文档已经迁移到[这里](https://github.com/cosmos/hashgard/tree/master/docs).
