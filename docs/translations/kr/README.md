...
- [Hashgard](https://github.com/cosmos/hashgard/blob/master/docs/translations/kr/README.md): Hashgard 애플리케이션(현재 코스모스 허브 명칭)에 대한 모든 문서들이 있습니다. Hashgard 테스트넷에 참여하는 방법에 대한 정보
...
`hashgard` 애플리케이션(코스모스 허브의 애플리케이션)을 설치하고 퍼블릭 테스트넷에 참가하고 싶으시다면 여기를 클릭해주세요.
자체적인 `hashgard` 테스트넷을 운영하고 싶으시다면 **[여기](https://github.com/cosmos/hashgard/blob/master/docs/translations/kr/join-testnet.md)** 를 클릭해주세요.

자체적인 `hashgard` 테스트넷 운영을 원하시는 경우 **[여기](https://github.com/cosmos/hashgard/blob/master/docs/translations/kr/deploy-testnet.md)** 를 확인하세요
