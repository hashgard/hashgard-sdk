...
Blockchain Node |  |           Consensus           |  |
                ...
                v  +-------------------------------+  v
```
The blockchain full-node presents itself as a binary, generally suffixed by `-d` for "daemon" (e.g. `appd` for `app` or `hashgardd` for `hashgard`). This binary is built by running a simple `main.go` function placed in `cmd/appd/`. This operation usually happens through the [Makefile](#dependencies-and-makefile).
...
You can see an example of application type definition [here](https://github.com/cosmos/hashgard/blob/master/app/app.go#L73-L107).
...
You can see an example of application constructor [here](https://github.com/cosmos/hashgard/blob/master/app/app.go#L110-L222).
...
You can see an example of an `InitChainer` [here](https://github.com/cosmos/hashgard/blob/master/app/app.go#L235-L239).
...
You can see an example of `BeginBlocker` and `EndBlocker` functions [here](https://github.com/cosmos/hashgard/blob/master/app/app.go#L224-L232).
...
You can see an example of a `MakeCodec` [here](https://github.com/cosmos/hashgard/blob/master/app/app.go#L64-L70)
