...
Example:
$ %s tx staking delegate gardvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 1000stake --from mykey
`,
				version.ClientName,
			),
		),
...
Example:
$ %s tx staking redelegate gardvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4 gardvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 100gard --from mykey
`,
				version.ClientName,
			),
		),
