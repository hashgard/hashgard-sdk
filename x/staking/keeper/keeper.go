...
//HashGard
func (k Keeper) CheckBondedRatio(ctx sdk.Context) sdk.Error {
	//if k.BondedRatio(ctx).LT(sdk.MustNewDecFromStr("0.3")) {
	//	return sdk.ErrInternal("The bonded ratio is less than thirty percent and cannot be submit proposal")
	//}
	return nil
}
