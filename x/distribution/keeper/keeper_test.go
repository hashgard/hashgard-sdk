...
func TestWithdrawValidatorCommission(t *testing.T) {
	...
	valCommission := sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("ugard", sdk.NewDec(3).Quo(sdk.NewDec(2))),
	}
	...
	distrAcc.SetCoins(sdk.NewCoins(
		...
		sdk.NewCoin("ugard", sdk.NewInt(2)),
	))
	...
	expCoins := sdk.NewCoins(sdk.NewCoin("ugard", expTokens))
	...
	require.Equal(t, sdk.NewCoins(
		...
		sdk.NewCoin("ugard", expTokens.AddRaw(1)),
	), balance)
	...
	require.Equal(t, sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("ugard", sdk.NewDec(1).Quo(sdk.NewDec(2))),
	}, remainder)
