...
Example:
$ %s tx distr withdraw-rewards gardvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4 --from mykey
$ %s tx distr withdraw-rewards gardvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4 --from mykey --commission
`,
...
Example:
$ %s tx set-withdraw-addr gard1jynf8n98d8af5e9arg3py3juserqy5gl6q9rec --from mykey
`,
				version.ClientName,
			),
		),
