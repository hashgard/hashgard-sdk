...
Example:
$ %s query distr validator-outstanding-rewards gardvaloper1lwjmdnks33xwnmfayc64ycprww49n33mtm92ne
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr commission gardvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr slashes gardvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4 0 100
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr rewards gard1jynf8n98d8af5e9arg3py3juserqy5gl6q9rec
$ %s query distr rewards gard1jynf8n98d8af5e9arg3py3juserqy5gl6q9rec gardvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4
`,
