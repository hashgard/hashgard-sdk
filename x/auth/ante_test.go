...
func TestEnsureSufficientMempoolFees(t *testing.T) {
	...
	ctx := input.ctx.WithMinGasPrices(
		sdk.DecCoins{
			...
			sdk.NewDecCoinFromDec("ugard", sdk.NewDecWithPrec(10000000000000, sdk.Precision)),   // 0.000001stake
		},
	)
	...
	testCases := []struct {
		...
		{NewStdFee(200000, sdk.NewCoins(sdk.NewInt64Coin("ugard", 1))), false},
		{NewStdFee(200000, sdk.NewCoins(sdk.NewInt64Coin("ugard", 2))), true},
