...
func TestGenesisAccountValidate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			NewGenesisAccountRaw(addr, sdk.NewCoins(sdk.NewInt64Coin("ugard", 50)),
				sdk.NewCoins(sdk.NewInt64Coin("ugard", 100)), 0, 0, "", ""),
		...
		},
		{
			...
			NewGenesisAccountRaw(addr, sdk.NewCoins(sdk.NewInt64Coin("ugard", 50)),
				sdk.NewCoins(sdk.NewInt64Coin("ugard", 50)), 1654668078, 1554668078, "", ""),
